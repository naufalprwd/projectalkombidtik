...
<div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                <label class="form">Pangkat      :</label>
                <b><?php echo $row['pangkat'];?></b>
                </li>
                <li class="list-group-item">
                      ...
                      <!--  <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="unit_kerja" class="form-control">
                                <option value="Pimpinan Perwakilan" <?php echo $row['pangkat'] == 'Pimpinan Perwakilan' ? 'selected' : '' ?>>Pimpinan Perwakilan</option>
                                <option value="Sekretariat Perwakilan" <?php echo $row['pangkat'] == 'Sekretariat Perwakilan' ? 'selected' : '' ?>>Sekretariat Perwakilan</option>
                                <option value="Subaud Jateng I"<?php echo $row['pangkat'] == 'Subaud Jateng I' ? 'selected' : '' ?>>Subaud Jateng I</option>
                                <option value="Subaud Jateng II"<?php echo $row['pangkat'] == 'Subaud Jateng II' ? 'selected' : '' ?>>Subaud Jateng II</option>
                                <option value="Subaud Jateng III"<?php echo $row['pangkat'] == 'Subaud Jateng III' ? 'selected' : '' ?>>Subaud Jateng III</option>
                                <option value="Subaud Jateng IV"<?php echo $row['pangkat'] == 'Subaud Jateng IV' ? 'selected' : '' ?>>Subaud Jateng IV</option>
                                <option value="Subbag TU Kalan" <?php echo $row['pangkat'] == 'Subbag TU Kalan' ? 'selected' : '' ?>>Subbag TU Kalan</option>
                                <option value="Subbag Umum dan TI"<?php echo $row['pangkat'] == 'Subbag Umum dan TI' ? 'selected' : '' ?>>Subbag Umum dan TI</option>
                                <option value="Subbag SDM"<?php echo $row['pangkat'] == 'Subbag SDM' ? 'selected' : '' ?>>Subbag SDM</option>
                                <option value="Subbag Keuangan"<?php echo $row['pangkat'] == 'Subbag Keuangan' ? 'selected' : '' ?>>Subbag Keuangan</option>
                                <option value="Subbag Humas"<?php echo $row['pangkat'] == 'Subbag Humas' ? 'selected' : '' ?>>Subbag Humas</option>
                                <option value="Subbag Hukum"<?php echo $row['pangkat'] == 'Subbag Hukum' ? 'selected' : '' ?>>Subbag Hukum</option>
                            </select>
                        </div> -->
                        <div class="input-group">
