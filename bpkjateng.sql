...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2024 at 10:35 AM
...
INSERT INTO `admin` (`id_admin`, `nip`, `nama`, `pangkat`, `jabatan`, `email`, `telpon`, `kesatuan`, `password`) VALUES
...
INSERT INTO `datapegawai` (`id_data`, `nama`, `nip`, `jabatan`, `email`, `telpon`, `pangkat`, `kesatuan`, `password`) VALUES
...
INSERT INTO `pinjaman` (`id_peminjam`, `nip`, `kode_jenis`, `nama`, `pangkat`, `jabatan`, `tipe_barang`, `jenis_barang`, `tanggal_pinjam`, `tanggal_kembali`, `nup`, `jumlah`, `peruntukan`) VALUES
...
ALTER TABLE `datapegawai`
  ...
  ADD UNIQUE KEY `username` (`kesatuan`),
