...
-->         <td width="90%" align="center">
                      <h4 style="text-align: center;">BID TIK POLDA RIAU</h4>
                      <h4 style="text-align: center;">PROVINSI RIAU</h4>
                  </td>
...
$unit = isset($row['pangkat']) ? $row['pangkat'] : 
...
Tanggal Dikembalikan: <?php echo $tgl ?> <br>
                  ...
                  <table id="example1" class="table table-bordered table-striped" width="100%">
                      ...
                      <tr>
                          <td width="30%" align="left">
                              ...
                              <p align="center">Yang Mengembalikan</p><br><br><br><br>
